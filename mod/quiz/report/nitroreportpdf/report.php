...
if(count($quiz_users)==0):
	...
	$progress_user=number_format(floor(6*(100/$PROGRESSBAR_PARTS)/count($quiz_users)),2,'.','');
endif;
$user_i=1;
foreach($quiz_users AS $users):
	$this->SetBarWidth(($progress_user*$user_i+60));
	@ob_flush();
	@flush();
...
endforeach;
///////////////////////////////////////////////////////////
$this->SetBarWidth(number_format(floor(7*(100/$PROGRESSBAR_PARTS)),2,'.',''));
@ob_flush();
@flush();
$mpdf->AddPage();
